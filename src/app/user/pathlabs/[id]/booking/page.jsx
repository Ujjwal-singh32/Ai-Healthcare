    ...
    >
      ...
      <div className="relative z-10 bg-white/30 backdrop-blur-lg shadow-2xl p-10 rounded-3xl max-w-md w-full text-center border border-white/30">
        ...
        <button
          ...
          disabled={loading}
          className={`relative bg-purple-600 hover:bg-purple-700 text-white font-semibold px-8 py-3 rounded-full shadow-lg transition duration-300 transform hover:scale-105 focus:outline-none cursor-pointer ${loading ? "opacity-50 cursor-not-allowed" : "animate-pulse"
            }`}
        >
          {loading ? (
