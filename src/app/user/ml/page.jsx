...
// IMPORTANT: Update these paths to point to your actual User Navigation and Footer components
...
export default function UserMLPredictionPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-[#f0f9ff] via-[#e0f2fe] to-[#dbeafe] dark:from-[#0f172a] dark:via-[#1e3a8a] dark:to-[#1e40af] transition-colors duration-500 ease-in-out">
      ...
      <main className="flex-grow pt-24 pb-16 px-4">
        ...
        <div className="relative max-w-4xl mx-auto text-center space-y-10 backdrop-blur-sm">
          ...
          <p className="text-lg text-gray-700 dark:text-gray-200">
            Describe your symptoms naturally to leverage our AI model and receive
          ...
          <div className="mt-8 p-6 bg-white/80 dark:bg-gray-900/50 backdrop-blur-md shadow-xl rounded-2xl border border-blue-100 dark:border-blue-900/50">
            <div className="text-left mb-6">
              ...
              <textarea
                ...
                placeholder="E.g., I have been experiencing severe headaches, mild fever, and nausea over the last 48 hours."
              />
            </div>
        ...
        {/* Prediction Result Sections (Doctor UI) */}
        {prediction && (
      ...
      {/* User Specific Chatbot Section */}
      <div className="w-full">
        <div className="border-t-2 bg-blue-400 border-blue-200 rounded-full mx-4" />
      </div>
